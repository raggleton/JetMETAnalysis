...
const char Pt[NPtBins+1][10]          = 
// {"10","14","18","22","26","30","35","40","45","57","72","90","120","150",
// {10   12    15   19   24   30   35   40   48,"57","72","90","120","150",
{"10","16","24","32","40","48","57","72","90","120","150",
										 "200","300","400","550","750","1000","1500","2000","2500","3000",
										 "3500","4000","4500","5000","5500","6000","6500","7000","7500",
										 "8000","8500","9000","9500","10000"};

const char eta_boundaries[NETA+1][10] = {"0", "0.261", "0.522", "0.783",
"1.044", "1.305", "1.479", "1.653", "1.93", "2.172", "2.322", "2.5", "2.65",
"2.853", "2.964", "3.139", "3.489", "3.839", "5.191"};

// const char eta_boundaries[NETA+1][10] = {"-5.191", "-3.839", "-3.489", "-3.139", "-2.964", "-2.853", 
// "-2.65", "-2.5", "-2.322", "-2.172", "-1.93", "-1.653", "-1.479", "-1.305", "-1.044", "-0.783", "-0.522", "-0.261", 
// "0", "0.261", "0.522", "0.783",
// "1.044", "1.305", "1.479", "1.653", "1.93", "2.172", "2.322", "2.5", "2.65",
// "2.853", "2.964", "3.139", "3.489", "3.839", "5.191"};

// const char eta_boundaries[NETA+1][10] = {"0", "0.783", "1.305", "1.93", "2.5", "3.139", "5.191"};
...
const double veta[NETA+1] = {0, 0.261, 0.522, 0.783, 1.044, 1.305, 1.479, 1.653, 1.93, 2.172, 2.322, 2.5,
2.65, 2.853, 2.964, 3.139, 3.489, 3.839, 5.191};

// const double veta[NETA+1] = {0, 0.783, 1.305, 1.93, 2.5, 3.139, 5.191};

// const double veta[NETA+1] = {-5.191, -3.839, -3.489, -3.139, -2.964, -2.853, -2.65, 
//   -2.5, -2.322, -2.172, -1.93, -1.653, -1.479, -1.305, -1.044, -0.783, -0.522, 
//   -0.261, 0, 0.261, 0.522, 0.783, 1.044, 1.305, 1.479, 1.653, 1.93, 2.172, 2.322, 2.5,
// 2.65, 2.853, 2.964, 3.139, 3.489, 3.839, 5.191};
