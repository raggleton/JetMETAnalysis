...
def create_condor_template_dict():
    template = {
        ...
        "universe": "vanilla",
        "output": "JAJ_$(name)_$(Cluster)_$(Process).out",
        "error": "JAJ_$(name)_$(Cluster)_$(Process).err",
        "log": "JAJ_$(name)_$(Cluster)_$(Process).log",
        "RequestMemory": "2G",
...
# ("QCD_Pt_800to1000_NoJEC_newFlav", "/pnfs/desy.de/cms/tier2/store/user/raggleto/QCD_Pt_800to1000_TuneCUETP8M1_13TeV_pythia8/crab_QCD_Pt_800to1000_pythia_18_Jun_18_noJEC_storePFCand2_storePhysicsAlgoHadronFlav/*/*/"),
