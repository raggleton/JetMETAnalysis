...
BASE_ERA = os.path.basename(ORIGINAL_ERA_DIR.rstrip("/"))
...
# run on ntuples
infos_qcd_pythia = {
    "name": "QCD_Pt_15toInf_NoJEC_newFlav",  # defines final hadded name
    "infos":[
        {
...
# ==============================================================================
# infos_qcd_ht_pythia = {
    # "name": "QCD_HT50toInf_NoJEC_newFlav",
    # "infos": [
    # {
...
infos_dy_pythia = {
    "name": "DYJetsToLL_HT-70toInf_NoJEC_newFlav",
    "infos": [
        {
...
infos_gjets_pythia = {
    "name": "GJets_HT-40ToInf_NoJEC_newFlav",
    "infos": [
        {
...
infos_qcd_herwig = {
    ...
    "infos": [
        {
            "name": "QCD_Pt_15to7000_Herwig_NoJEC_newFlav_small",
            "input": "%s/QCD_Pt_15to7000_Herwig_NoJEC_newFlav_small/" % QCD_HERWIG_INPUT_DIR,
            "xsec": -1,
        ...
        {
            "name": "QCD_Pt_15to7000_Herwig_NoJEC_newFlav_ext",
            "input": "%s/QCD_Pt_15to7000_Herwig_NoJEC_newFlav_ext/" % QCD_HERWIG_INPUT_DIR,
            "xsec": -1,
            "output_dir": QCD_HERWIG_OUTPUT_DIR,
            "era_dir": HERWIG_ERA_DIR,
            "nrefmax": QCD_NREFMAX,
...
# ending of the JEC txt files to use
era_append = "_standardMedianErr_allMedian_rspRangeLarge_fitMin10_fitFuncstandard_HadronParton_minRelCorErr0p01_setFitMinTurnoverPlusOne_plateauBelowRangeMin_minRelCorErrMaxRelDiffCompete"
...
for algo in all_algos:
    ...
    for flav, flav_name in flav_dict.iteritems():
        ...
        for info_dict in [infos_qcd_pythia, infos_qcd_herwig][:]:
            ...
            for sample_dict in info_dict['infos']:
                ...
                args_dict = {
                    ...
                    "era": "%s_%s_%s" % (BASE_ERA, era_append, flav_name),
